...
from basicsr.models.archs.WPT_arch import DWT, IWT
...
class RCAB(nn.Module):
    ...
    def __init__(self, num_feat, squeeze_factor=16, res_scale=1):
        ...
        self.rcab = nn.Sequential(
            ...
            self.DWT,
            ChannelAttention(num_feat*4, squeeze_factor),
            self.IWT)
...
class WAN(nn.Module):
    ...
    def __init__(self,
        ...
        BasicModule_f = functools.partial(ResidualGroup,
                                          num_feat=num_feat,
                                          num_block=num_block,
                                          squeeze_factor=squeeze_factor,
                                          res_scale=res_scale)
        self.conv_first = nn.Conv2d(num_in_ch, num_feat, 3, 1, 1)
        self.body = make_layer(BasicModule_f, num_group)
