...
from basicsr.models.archs.WPT_arch import loss_Textures
    ...
    def forward(self, input, target, weight=None, **kwargs):
        ...
        Args:
            ...
            weight (Tensor, optional): of shape (N, C, H, W). Element-wise
                weights. Default: None.
        """
        # return self.loss_weight * nn.MSELoss(
        #     input, target, weight, reduction=self.reduction)
        return self.loss_weight * mse_loss(
            input, target, weight, reduction=self.reduction)
    ...
    def forward(self, input, target, weight=None, **kwargs):
        ...
        Args:
            ...
            weight (Tensor, optional): of shape (N, C, H, W). Element-wise
                weights. Default: None.
        """
        return self.loss_weight * loss_Textures(
            input[:,0:3,:,:], target[:,0:3,:,:])

class GauLapLoss(nn.Module):
    """wavelet (L2) loss.
    ...
    def __init__(self, loss_weight=1.0, reduction='mean'):
        super(GauLapLoss, self).__init__()
